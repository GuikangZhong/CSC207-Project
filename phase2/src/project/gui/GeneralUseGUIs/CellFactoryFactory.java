...
public class CellFactoryFactory {
    public static Callback<ListView<Applicant>, ListCell<Applicant>>  getCellFactoryForApplicant(){
    ...
    public static Callback<ListView<Interviewer>, ListCell<Interviewer>>  getCellFactoryForInterviewer(){
    ...
    public static Callback<ListView<InterviewGroup>, ListCell<InterviewGroup>>  getCellFactoryForInterviewGroup(){
    ...
    public static Callback<ListView<JobPosting>, ListCell<JobPosting>>  getCellFactoryForJobPosting(){
